$(document).ready(function() {
  ...
  function insertObjects() {
    ...
    $('.gameDiv[data-x="' + playerPos.x + '"][data-y="' + playerPos.y + '"]').html('<img style="width:100%;height:100%;" src="/img/vampire.gif">');
    $('.gameDiv[data-x="' + goalPos.x + '"][data-y="' + goalPos.y + '"]').html('<img style="width:100%;height:100%;" src="/img/goal.png">');
    $('.gameDiv[data-x="' + monsterPos.x + '"][data-y="' + monsterPos.y + '"]').html('<img style="width:100%;height:100%;" src="/img/mummy.jpg">');
  ...
  function movePlayer(direction) {
    ...
    if(direction == "UP") {
      if((currentPlayerPos.y - 1) > 0) {
        ...
        $('.gameDiv[data-x="' + currentPlayerPos.x + '"][data-y="' + currentPlayerPos.y + '"]').html('<img style="width:100%;height:100%;" src="/img/vampire.gif">');
    ...
    if(getRandNumber(2) == 1) {
      if(getRandNumber(2) == 1) {
        if((currentMonsterPos.y - 1) > 0) {
          ...
          $('.gameDiv[data-x="' + currentMonsterPos.x + '"][data-y="' + currentMonsterPos.y + '"]').html('<img style="width:100%;height:100%;" src="/img/mummy.jpg">');
